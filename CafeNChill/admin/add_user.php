...
<head>
    ...
    <title>Cafe N Chill | Add User</title>
    ...
    <style>
       ...
       -webkit-appearance: none;
        ...
        h1 { color: var(--cream-accent); margin-bottom: 30px; text-align: center; font-weight: 600; }
        .input-group { margin-bottom: 15px; }
        label { display: block; margin-bottom: 8px; font-size: 0.85rem; color: #a8a29e; }
        ...
        input:focus, select:focus { border-color: var(--coffee-brown); }
        select option { background: var(--sidebar-color); color: white; }
        ...
        .cancel-link:hover { color: var(--cream-accent); text-decoration: underline; }
    </style>
</head>
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST" autocomplete="off">
            ...
            <div class="input-group">
                ...
                <input type="text" name="name" placeholder="Enter complete name" required autocomplete="new-password">
            </div>
